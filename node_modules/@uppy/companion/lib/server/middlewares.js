...
exports.cors = (options = {}) => (req, res, next) => {
    ...
    const exposeHeadersSet = new Set((_a = existingExposeHeaders === null || existingExposeHeaders === void 0 ? void 0 : existingExposeHeaders.split(',')) === null || _a === void 0 ? void 0 : _a.map((method) => method.trim().toLowerCase()));
    ...
    const allowMethodsSet = new Set((_b = existingAllowMethods === null || existingAllowMethods === void 0 ? void 0 : existingAllowMethods.split(',')) === null || _b === void 0 ? void 0 : _b.map((method) => method.trim().toUpperCase()));
