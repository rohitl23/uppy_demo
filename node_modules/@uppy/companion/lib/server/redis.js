...
module.exports.client = (companionOptions) => {
    if (!(companionOptions === null || companionOptions === void 0 ? void 0 : companionOptions.redisUrl) && !(companionOptions === null || companionOptions === void 0 ? void 0 : companionOptions.redisOptions)) {
        return redisClient;
    }
