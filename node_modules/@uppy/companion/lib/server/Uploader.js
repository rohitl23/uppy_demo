...
var _Uploader_instances, _Uploader_uploadState, _Uploader_canceled, _Uploader_emitSuccess, _Uploader_emitError, _Uploader_uploadTus, _Uploader_uploadMultipart, _Uploader_uploadS3Multipart;
    ...
    async _uploadByProtocol() {
        ...
        switch (protocol) {
            case PROTOCOLS.multipart:
                return __classPrivateFieldGet(this, _Uploader_instances, "m", _Uploader_uploadMultipart).call(this, this.readStream);
            case PROTOCOLS.s3Multipart:
                return __classPrivateFieldGet(this, _Uploader_instances, "m", _Uploader_uploadS3Multipart).call(this, this.readStream);
            case PROTOCOLS.tus:
...
_Uploader_uploadState = new WeakMap(), _Uploader_canceled = new WeakMap(), _Uploader_instances = new WeakSet(), _Uploader_emitSuccess = function _Uploader_emitSuccess(url, extraData) {
    const emitData = {
        action: 'success',
