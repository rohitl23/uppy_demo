...
class Zoom extends Provider {
    ...
    */
    async list(options) {
        return __classPrivateFieldGet(this, _Zoom_instances, "m", _Zoom_withErrorHandling).call(this, 'provider.zoom.list.error', async () => {
            const { token } = options;
    ...
    async download({ id: meetingId, token, query }) {
        return __classPrivateFieldGet(this, _Zoom_instances, "m", _Zoom_withErrorHandling).call(this, 'provider.zoom.download.error', async () => {
    ...
    async size({ id: meetingId, token, query }) {
        return __classPrivateFieldGet(this, _Zoom_instances, "m", _Zoom_withErrorHandling).call(this, 'provider.zoom.size.error', async () => {
            const client = getClient({ token });
            const { recordingStart, recordingId: fileId } = query;
            const foundFile = await findFile({ client, meetingId, fileId, recordingStart });
            if (!foundFile)
    ...
    async logout({ companion, token }) {
        return __classPrivateFieldGet(this, _Zoom_instances, "m", _Zoom_withErrorHandling).call(this, 'provider.zoom.logout.error', async () => {
    ...
    async deauthorizationCallback({ companion, body, headers }) {
        return __classPrivateFieldGet(this, _Zoom_instances, "m", _Zoom_withErrorHandling).call(this, 'provider.zoom.deauth.error', async () => {
...
_Zoom_instances = new WeakSet(), _Zoom_withErrorHandling = 
